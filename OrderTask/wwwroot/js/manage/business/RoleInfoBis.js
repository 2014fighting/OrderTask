    ...
    function () {
        ...
        $("#btnedit").on('click',
            function () {
                ...
                layer.open({
                    ...
                    maxmin: true, //开启最大化最小化按钮
                    area: ['893px', '600px'],
                    content: '/RoleInfo/EditRole/' + checkStatus.data[0].Id
                });
            });
        ...
        tableIns = table.render({
            ...
            , cols: [[ //标题栏
                ...
                , { field: 'IsActive', title: '是否激活', width:100, templet: '#checkboxTpl', unresize: true }
        ...
        //监听锁定操作
        form.on('checkbox(IsActiveDemo)', function (obj) {
        ...
        table.on('tool(test)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
            ...
            if (layEvent === 'detail') { //查看
                layer.open({
                    ...
                    maxmin: true, //开启最大化最小化按钮
                    area: ['893px', '600px'],
                    content: '/RoleInfo/EditRole/?Id=' + data.Id + '&type=2'
                });
                ...
                layer.open({
                    ...
                    maxmin: true, //开启最大化最小化按钮
                    area: ['893px', '600px'],
                    content: '/RoleInfo/EditRole/' + data.Id
                });
            }
        });
