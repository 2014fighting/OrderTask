...
namespace OrderTask.Model.Migrations
{
    ...
    [Migration("20180418055320_vicky4")]
            ...
            modelBuilder.Entity("OrderTask.Model.DbModel.BisnessModel.Evaluate", b =>
                {
                    ...
                    b.Property<string>("EvaluateInfo");

                    b.Property<int?>("OrderId");

                    b.Property<int?>("ReceivePersonId");
                    ...
                    b.Property<float?>("WorkProgress");

                    b.HasKey("Id");

                    b.HasIndex("OrderId");

                    b.HasIndex("ReceivePersonId");

                    b.ToTable("t_Evaluate");
                });

            modelBuilder.Entity("OrderTask.Model.DbModel.BisnessModel.Holiday", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<DateTime?>("HolidayTime");
            ...
            modelBuilder.Entity("OrderTask.Model.DbModel.BisnessModel.Evaluate", b =>
                {
                    ...
                    b.HasOne("OrderTask.Model.DbModel.BisnessModel.ReceivePerson", "ReceivePerson")
                        .WithMany()
                        .HasForeignKey("ReceivePersonId");
                });
